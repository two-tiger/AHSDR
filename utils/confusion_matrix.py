        ...
        for data in test_loader:
            ...
            with torch.no_grad():
                if 'class-il' not in model.COMPATIBILITY:
                    ...
                    if dataset.args.model == 'derppcct' and model.net.net.distill_classifier:
...
def plot_confusion(model, args, dataset):
    ...
    plt.savefig('graph/confusion_CVT_1000_f.pdf', dpi=600, format='pdf', pad_inches=0.01, bbox_inches='tight')
    plt.show()
