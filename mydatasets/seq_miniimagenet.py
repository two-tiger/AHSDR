...
import os
from mydatasets.utils.validation import get_train_val
from mydatasets.utils.continual_dataset import ContinualDataset, store_masked_loaders
from mydatasets.transforms.denormalization import DeNormalize
...
class SequentialMiniImagenet(ContinualDataset):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = MyMiniImagenet('./data/' + 'MINIIMG',
        ...
        if self.args.validation:
            ...
            test_dataset = MiniImagenet('./data/' + 'MINIIMG',
    ...
    def get_backbone_cct():
        output_dim = SequentialMiniImagenet.N_CLASSES_PER_TASK * SequentialMiniImagenet.N_TASKS
